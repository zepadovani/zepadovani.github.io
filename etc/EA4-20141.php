...
<?php
  ...
  //Fetching from your database table.
            $query = "SELECT * FROM $usertable WHERE code =
            '".$_GET["cod"]."'";
...
"
      <h2>
 EA4 - 2014.1 - relatório individual de notas e faltas at&eacute; o momento</a></h2>
    <h1>
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------- <br>
  ...
  echo "<tr> <td>";    
  echo "<b>número de faltas:</b>";
  echo "</td><td> <b>";    
  echo $row[27];
  echo "</b></td></tr>";

  echo "<tr> <td>"; 
    echo "<br><b> Exercício de Fixação 1:</b>";
    echo "</td><td><br><b>";        
  echo $row[18];
  echo "</b></td></tr>";

  echo "<tr> <td>"; 
    echo "<br><b> Exercício de Fixação 2:</b>";
    echo "</td><td><br><b>";        
  echo $row[19];
  echo "</b></td></tr>";

    echo "<tr> <td>"; 
    echo "<br><b> Exercício de Fixação 3:</b>";
    echo "</td><td><br><b>";        
  echo $row[20];
  echo "</b></td></tr>";

    echo "<tr> <td>"; 
    echo "<br><b> Exercício de Fixação 4:</b>";
    echo "</td><td><br><b>";        
  echo $row[21];
  echo "</b></td></tr>";
