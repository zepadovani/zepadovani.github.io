...
//  echo $query;  
  ...
  echo "
      <h2>
EA4 - 2012.2 - relatório individual de notas at&eacute; o momento</a></h2>
    <h1>
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------- <br>
  ...
  echo "<tr> <td>"; 
  echo "<br> Correção do primeiro trabalho (<b>AV1</b>):";
echo "</td><td><br>";        
  echo $row[16];
  echo "</td></tr>";

  echo "<tr> <td>"; 
  echo "<br> Correção do segundo trabalho (<b>AV2</b>):";
echo "</td><td>";
  echo "<br><a href=\"";
  echo $row[17];
  echo "\" target=\"_blank\">";  
  echo "Link para a correção (Google Docs)";
  echo "</a>";
  echo "</td></tr>";  
...
echo "</td><td><b>";       
  ...
  echo "<br><b>EF</b> - peso 2 <br>
    melhor nota nos Exercícios de Fixação [0 a 10] <br>
...
echo "</td><td><b><big><big>";        
  ...
  echo "<tr> <td>";
  echo "<br><b> Outras observações</b>: <br>";
  echo "</td><td><br>";
  echo htmlspecialchars(nl2br($row[18]));
  echo "</td></tr>";    
